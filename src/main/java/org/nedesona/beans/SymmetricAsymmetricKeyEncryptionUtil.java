...
public class SymmetricAsymmetricKeyEncryptionUtil {
	...
	public SymmetricAsymmetricKeyEncryptionUtil(EncryptionConfiguration cfg) throws KeyStoreException, NoSuchAlgorithmException,
	...
	private void loadTrustStore(EncryptionConfiguration cfg) throws KeyStoreException,
	NoSuchAlgorithmException, CertificateException, IOException {
		wcTrustStore = KeyStore.getInstance("JCEKS");
		wcTrustStorePassword = cfg.getTrustStorePassword() /* e.g. "password" */;
		// String filePath = wcCryptoConfig.getTrustStoreFileLocation() +
		// File.separator + wcCryptoConfig.getTrustStoreFile();
		FileInputStream stream = new FileInputStream(cfg.getTrustStoreFileName() /* e.g. "pptruststore.jck" */);
		wcTrustStore.load(stream, wcTrustStorePassword.toCharArray());
	}

	private void loadKeyStore(EncryptionConfiguration cfg) throws KeyStoreException,
	NoSuchAlgorithmException, CertificateException, IOException {
		visaKeyStore = KeyStore.getInstance("JCEKS");
		visaKeyStorePass = cfg.getKeyStorePassword() /* e.g. "password" */;
		// String filePath = wcCryptoConfig.getKeyStoreFileLocation() +
		// File.separator + wcCryptoConfig.getKeyStoreFile();
		FileInputStream stream = new FileInputStream(cfg.getKeyStoreFileName() /* e.g. "ppkeystore.jck" */);
